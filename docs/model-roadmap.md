...
**市場オッズ比率帯（currentOdds/requiredOdds）**:
- 1.0〜1.5x: ROI 0.53（損失、n=581）
- **1.5〜2.0x: ROI 0.959**（最良、n=286）← 市場とモデルが「ほぼ合意」の帯
- 2.0x超: ROI 0.0〜0.16（全滅帯）

**selection パターン**:
- 1-2-3: ROI 0.42（n=952）
- 1-3-2: ROI 1.234（n=62）← 三国・大村などで顕著
- 1-3-4: ROI 1.473（n=11, 過小）
