...
投票者の注意分散は`pnpm analyze:market-attention`で、公式番組の締切予定時刻から他場との前後2分・5分衝突、同一R集中、同日開催負荷、孤立時間を11因子×5買い目=55セルで検証した。parserの会場切替誤認を避け、同一場1〜12R完備かつ時刻単調増加のvenue-dayだけを使った。孤立10分以上×1-4は2024 ROI104.2%・2025 ROI111.0%だが、最大2的中除外で62.0%・78.7%。一方、前後5分に他場2本以上の混雑×1-4も両期残差プラスで、孤立と混雑という逆条件が同時に良く見える。単純なattention因果ではなく、時間帯・場・番組構成の交絡と配当集中として不採用。
