...
- **N2 official-program typed observation（2026-08-02）**: F0 registryへ`official_program / pre_race`を追加し、canonical race key、source observed時刻、course 1〜6の6艇、登録番号・級別・全国/当地勝率/2連率・motor/boat 2連率をexact-key/範囲検証する。未知field、重複course、非canonical identity、不正時刻をfail-closed。golden fixture hash=`06be00c42eaaaa9f5845d29e7af30a49740bc02b6f3694bcfe3afac7558cdb82`、契約tests 3/3・reader E2Eを含む合計10/10・targeted strict typecheck PASS。実collector生成とprimary raw_json値照合は未接続。
