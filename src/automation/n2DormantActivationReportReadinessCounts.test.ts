...
test("activation report rejects digest-valid READY evidence below the settled minimum", () => {
  ...
  assert.ok(report.blockers.includes("READINESS_READY_COUNTS_INCONSISTENT"));
