...
function writeCurrentDiscovery(root:string){
  ...
  const discovery={status:"PASS",scan:{status:"PASS",scanVersion:"n2-edge-hypothesis-scan-v2",signals:[]},outputDigest:canonicalHash({revision:"fixture-current"}),revision:"fixture-current"};
