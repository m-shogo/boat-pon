...
for (const nonActivatedQueueStatus of ["FAILED", "BLOCKED"] as const) {
  test(`baseline pair rejects one activated side when the peer queue is ${nonActivatedQueueStatus}`, () => {
    ...
    taskStatuses["TASK-N2-021"] = nonActivatedQueueStatus;
