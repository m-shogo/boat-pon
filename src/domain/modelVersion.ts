export const MODEL_VERSION = "boatpon-v4-conservative";
...
export function getModelVersionInfo(): ModelVersionInfo {
  return {
    ...
    description: "プロペラ制度レジーム、番組カテゴリ、強めのLaplace平滑化、信頼下限スコアを前提にした期待値モデル",
    features: [
      ...
      "会場内トップ買い目は平均推定率ではなく信頼下限スコアで選び、候補の的中率も保守的に扱う",
    ],
  };
}
