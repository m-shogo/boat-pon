...
test("bet-type selector summary derives headline evidence from current validated inputs", () => {
  const source = readFileSync("scripts/report-bet-type-selector-summary-internal.ts", "utf8");
