...
const RACE_KEY = "2024-08-01:05:R1";

test("edge holdout reader rejects a current settlement with a tampered semantic hash before primary reads", () => {
  const root = mkdtempSync(join(tmpdir(), "boat-pon-edge-holdout-semantic-hash-"));
