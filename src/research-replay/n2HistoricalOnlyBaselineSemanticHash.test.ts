...
const RACE_KEY = "2026-08-07:10:R1";

test("historical winner reader rejects a current settlement with a tampered semantic hash", () => {
  const root = mkdtempSync(join(tmpdir(), "boat-pon-historical-semantic-hash-"));
