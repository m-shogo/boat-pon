...
test("historical alternative-odds quality rejects forward cohort drift before report implementation", () => {
  ...
  assert.ok(implementationImport > failure, "quality implementation must load only after cohort validation");
});
