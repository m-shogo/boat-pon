...
test("selection profile rejects producer-impossible payout selection lineage", () => {
  const db = fixture();
  try {
...
test("selection profile rejects producer-impossible refund selection lineage", () => {
  const db = fixture();
  try {
