...
test("ineligible program lineage is rejected before primary raw projection is touched", () => {
  const dir = mkdtempSync(join(tmpdir(), "n2-feature-primary-raw-preflight-"));
