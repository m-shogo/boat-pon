...
test("all-feature settlement gate is canonical, read-only, query-only, and rejects ambiguous winning keys", () => {
  ...
  assert.match(gate, /SELECT DISTINCT race_id, bet_type, selection/);
