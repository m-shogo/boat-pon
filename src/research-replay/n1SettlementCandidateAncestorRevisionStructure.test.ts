...
test("revised settlement candidate rejects an ancestor marked initial while still superseding", () => {
  ...
  try {
    ...
    insert.run("prior", RACE, "trifecta", "settled", "normal", "initial", "ancestor", null, semanticHash);
