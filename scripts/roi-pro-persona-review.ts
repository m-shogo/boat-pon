...
assertCanonicalDirectory("reports", "ROI_PERSONA_REVIEW_REPORTS_DIRECTORY_IDENTITY_INVALID");
...
atomicPublish(
  ...
  "ROI_PERSONA_REVIEW_JSON_PUBLISH_DESTINATION_IDENTITY_INVALID",
);
atomicPublish(
  OUT_MD,
  renderMarkdown(report),
  "ROI_PERSONA_REVIEW_MD_PUBLISH_TEMP_IDENTITY_INVALID",
  "ROI_PERSONA_REVIEW_MD_PUBLISH_DESTINATION_IDENTITY_INVALID",
);
...
function atomicPublish(
  ...
  assertCanonicalDirectory(parentPath, "ROI_PERSONA_REVIEW_PUBLISH_PARENT_IDENTITY_INVALID");
  ...
  try {
    ...
    assertCanonicalDirectory(parentPath, "ROI_PERSONA_REVIEW_PUBLISH_PARENT_HANDOFF_IDENTITY_INVALID");
