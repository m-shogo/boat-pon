...
function atomicPublish(
  ...
  assertCanonicalDirectory(parentPath, "ALL_BET_TYPES_ROI_PUBLISH_PARENT_IDENTITY_INVALID");
  ...
  try {
    ...
    assertCanonicalDirectory(parentPath, "ALL_BET_TYPES_ROI_PUBLISH_PARENT_HANDOFF_IDENTITY_INVALID");
...
try {
  ...
  assertCanonicalDirectory("reports", "ALL_BET_TYPES_ROI_REPORTS_DIRECTORY_IDENTITY_INVALID");
  if (existsSync(OUT_MD)) {
    assertCanonicalSingleLinkRegularFile(
      OUT_MD,
      "ALL_BET_TYPES_ROI_MD_PREPUBLISH_DESTINATION_IDENTITY_INVALID",
    );
  }
  if (existsSync(OUT_JSON)) {
    assertCanonicalSingleLinkRegularFile(
      OUT_JSON,
      "ALL_BET_TYPES_ROI_JSON_PREPUBLISH_DESTINATION_IDENTITY_INVALID",
    );
  }
  atomicPublish(
    OUT_MD,
