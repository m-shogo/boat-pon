 ...
 *
 * The legacy implementation classified 2/3-dimension combinations using a
 * quote-derived hit return from paper_roi_candidates as realized ROI. Quoted
 * odds are not canonical settled return, so strong/watch/weak labels from that
