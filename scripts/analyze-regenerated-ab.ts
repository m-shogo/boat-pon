 ...
 * historical feature comparison, but it still treated saved/current market
 * odds as realized returns when computing ROI. That return basis is not
 * authoritative settlement and can distort model-pattern conclusions.
 *
