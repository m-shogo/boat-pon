...
生成日時: 2026-06-09T12:31:11.765Z
governor 生成日時: 2026-06-09T12:31:05.913Z
...
## 次アクション: skip6R historical alternative odds 小規模 backfill (残 192/215件)
...
8. 満足なら残り write
   ```bash
   pnpm backfill:historical-alt-odds --limit 192 --priority skip6R --write --sleep-ms 1000
   ```
...
| skip6R historical closing odds | 23/215 (11%) ❌ |
| skipVenue historical closing odds | 16/159 (10%) ❌ |
