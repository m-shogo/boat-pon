...
| 総レコード数 | 297 |
| ユニーク race 数 | 60 |
| データ期間 | 2025-08-02 〜 2025-11-08 |
| 5買い目全て揃っている race 数 | 59 / 60 (98%) |
...
| 項目 | 件数 | 率 | 判定 |
|---|---:|---:|---|
| source_type=official_archive | 297 | 100% | ✅ |
| source_quality=historical_closing_odds | 297 | 100% | ✅ |
| is_backfill=1 | 297 | 100% | ✅ |
| source_url あり | 297 | 100% | ✅ |
| fetched_at あり | 297 | 100% | ✅ |
| parser_version あり | 297 | 100% | ✅ |
