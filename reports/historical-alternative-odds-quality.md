...
| 項目 | 件数 | 率 | 判定 |
|---|---:|---:|---|
| source_type=official_archive | 982 | 100% | ✅ |
| source_quality=historical_closing_odds | 982 | 100% | ✅ |
| is_backfill=1 | 982 | 100% | ✅ |
| source_url あり | 982 | 100% | ✅ |
| fetched_at あり | 982 | 100% | ✅ |
| parser_version あり | 982 | 100% | ✅ |
