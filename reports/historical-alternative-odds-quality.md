...
| 項目 | 件数 | 率 | 判定 |
|---|---:|---:|---|
| source_type=official_archive | 832 | 100% | ✅ |
| source_quality=historical_closing_odds | 832 | 100% | ✅ |
| is_backfill=1 | 832 | 100% | ✅ |
| source_url あり | 832 | 100% | ✅ |
| fetched_at あり | 832 | 100% | ✅ |
| parser_version あり | 832 | 100% | ✅ |
