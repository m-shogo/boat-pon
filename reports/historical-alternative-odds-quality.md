...
| 5買い目全て揃っている race 数 | 256 / 257 (100%) |
| 4買い目のみの race 数 | 0 (欠場等で正常なスキップ) |
| condB 該当 race 数 | 167 / 167 |
| skip6R 該当 race 数 | 113 / 215 (53%) |
| skipVenue 該当 race 数 | 29 / 159 (18%) ※下記注意参照 |
| skip6R × skipVenue 重複 | 20 |
...
| 項目 | 件数 | 率 | 判定 |
|---|---:|---:|---|
| source_type=official_archive | 1282 | 100% | ✅ |
| source_quality=historical_closing_odds | 1282 | 100% | ✅ |
| is_backfill=1 | 1282 | 100% | ✅ |
| source_url あり | 1282 | 100% | ✅ |
| fetched_at あり | 1282 | 100% | ✅ |
| parser_version あり | 1282 | 100% | ✅ |
...
**✅ 品質良好。skip6R 次バッチ (pnpm backfill:historical-alt-odds --limit 30 --priority skip6R --write --sleep-ms 1000) へ進んでよい。残 102/215 件。**
